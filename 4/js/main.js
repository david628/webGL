...
let earthImg, earthData, earthParticles = new THREE.Object3D(),
    ...
    dotTexture = new THREE.TextureLoader().load(PATH + 'dot.png'),
    coneImg = [PATH + 'lightray.jpg', PATH + 'lightray_yellow.jpg'],
...
gl_FragColor = vec4( texColor.rgb * diffuse, _a );
    ...
    let geometry = new THREE.SphereGeometry(radius + 12, 66, 44),
        map = new THREE.TextureLoader().load(PATH + 'clouds.jpg')
